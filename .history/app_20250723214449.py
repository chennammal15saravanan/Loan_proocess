...
def add_loan():
    ...
    try:
        ...
        # Verify uploads
        if not (aadhar_upload.status_code == 200 and pan_upload.status_code == 200):
            logger.error(f"File upload failed: Aadhar status {aadhar_upload.status_code}, PAN status {pan_upload.status_code}")
