...
def add_loan():
    ...
    try:
        ...
        # Generate unique filenames using secure_filename
        aadhar_filename = secure_filename(aadhar_file.filename)
        pan_filename = secure_filename(pan_file.filename)

        # Create unique paths for storage
        aadhar_path = f'documents/aadhar/{user_id}_{uuid.uuid4()}_{aadhar_filename}'
        pan_path = f'documents/pan/{user_id}_{uuid.uuid4()}_{pan_filename}'
        ...
        # Generate public URLs for the uploaded files (optional, if needed)
        ...
        loan_data = {
            ...
            'aadhaar_url': aadhar_url,  # Store public URL
            'pan_url': pan_url,        # Store public URL
            'status': 'pending',
