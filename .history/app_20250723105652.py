...
def add_loan():
    ...
    try:
        ...
        # Upload Aadhar file
        aadhar_upload = supabase.storage.from_(bucket_name).upload(aadhar_filename, aadhar_file.read(), {
            "content-type": "application/pdf"
        })
        logger.info(f"Aadhar file uploaded: {aadhar_filename}")

        # Upload PAN file
        pan_upload = supabase.storage.from_(bucket_name).upload(pan_filename, pan_file.read(), {
            "content-type": "application/pdf"
        })
