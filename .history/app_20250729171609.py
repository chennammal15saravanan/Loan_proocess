...
def get_loan_details(id):
    ...
    try:
        ...
        response_data = {
            ...
            'aadhaar_number': loan_data.get('aadhaar_number'),
            'pan_number': loan_data.get('pan_number'),
            'aadhaar_url': loan_data.get('aadhaar_url'),
            'pan_url': loan_data.get('pan_url'),
            'status': loan_data['status'].capitalize() if loan_data['status'] else 'N/A',
            'created_at': loan_data.get('created_at'),
            'review_status': loan_data.get('review_status'),
