...
def signup():
    if request.method == 'POST':
        ...
        try:
            ...
            # Set session with the new user's tokens
            ...
            if access_token and refresh_token:
                ...
                signin_response = supabase.auth.sign_in_with_password({"email": email, "password": password})
                if signin_response.session:
                    ...
                    return render_template('sign-up.html', error="Signup succeeded but unable to authenticate.")
            ...
            if "already registered" in error_message.lower():
                ...
                error_message = "Permission denied when saving profile. Check RLS policies."
