...
@app.route('/dashboard')
def dashboard():
    """Dadhboard page for different roles thst it match the exact users  """
...
def add_product():
    ...
    if not all([name, price]):
        ...
        return redirect(url_for('dashboard'))  # Or wherever the form is
    ...
    return redirect(url_for('dashboard'))  # Or your product list page
