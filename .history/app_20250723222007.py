...
def add_loan():
    ...
    try:
        ...
        if not all(required_fields) or not aadhar_file or not pan_file:
            logger.error(f"Missing required fields: {request.form}, files: {aadhar_file is None}, {pan_file is None}")
        ...
        if aadhar_file.content_length > max_size or pan_file.content_length > max_size:
